...
\newcommand{\uncertaintrees}{Paper IV\xspace}
\newcommand{\boostvht}{Paper V\xspace}
...
\newcommand{\uncertaintreesNum}{IV\xspace}
\newcommand{\boostvhtNum}{V\xspace}
\newcommand{\blockgbtNum}{VI\xspace}

% Research Question
\newcommand{\researchQuestion}{\emph{How can we use approximations and parallelism to develop scalable learning algorithms?}}
...
\SetKw{Not}{ not }
\DontPrintSemicolon
\newcommand{\define}{\ensuremath{{\,\leftarrow\,}}\xspace}
\newcommand{\ensemble}{\ensuremath{\mathbf{h}}\xspace}
