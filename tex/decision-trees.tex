...
...\todo{CART, ID3, decision criteria, base learning algorithms.}
...
adapt to concept drift \todo{Make use we've defined concept drift before.}
based on the Page-Hinckley change detection test~\cite{ph-test}.
