...
and describe our approach in Section \ref{sec:concepts-method}. We present our
...
approach, made possible by modeling the generality of the graph representation. In the paper we present examples from the linguistic,
music, and molecular biology domains, and here we provide an additional example using
